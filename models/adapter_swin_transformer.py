...
from .memory import LayerNorm, UMA
...
class Adapter_SwinTransformer(nn.Module):
    r""" Swin Transformer
    ...
    def __init__(self, is_efficient_finetune=False, filter_strategy1=18, filter_strategy2=6, pretrain_image_size=224,
