...
def test_MobileNetV3(num_classes: int = 1000, **kwargs):
    # trained ImageNet-1K
...
if __name__ == '__main__':
    ...
    net = test_MobileNetV3().cuda()
    net.eval()
    print(net)

    # weights_path = "/mnt/f/1.中国农大/数据集/vcnu_pretrain_weight/pretrain/pretrain_weights/mobilenetv3/450_act3_mobilenetv3_large.pth"
