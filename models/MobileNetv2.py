...
def test_mobilenetv2(num_classes: int = 1000, **kwargs):
    # trained ImageNet-1K
    # https://github.com/d-li14/mobilenetv2.pytorch?tab=readme-ov-file
    model = mobilenetv2()
    return model
...
if __name__ == '__main__':
    ...
    net = test_mobilenetv2().cuda()
    print(net)

    weights_path = "/mnt/f/1.中国农大/数据集/vcnu_pretrain_weight/pretrain/pretrain_weights/mobilenetv2/mobilenetv2_224.pth"
