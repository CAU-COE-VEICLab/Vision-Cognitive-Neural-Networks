...
if __name__ == '__main__':
    ...
    net = get_efficientnet_v2(model_name ='efficientnet_v2_s' , nclass=96, dropout=0.1, stochastic_depth=0.2).cuda()
    print(net)
    # # load_from_zoo(model, "efficientnet_v2_xl_in21k",pretrained_path=r'D:\2self\AgriPTM-learning\weights\efficientnet')
    # load_from_path(net, pretrained_path='/mnt/f/1.中国农大/数据集/vcnu_pretrain_weight/pretrain/pretrain_weights/efficientnet/efficientnet_v2_xl_in21k/efficientnetv2-xl-21k.npy')
