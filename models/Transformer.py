...
class Transformer(nn.Module):
    ...
    def __init__(self, num_layers, dim, num_heads, ff_dim, dropout, attention_dropout):
        super().__init__()
...
if __name__ == '__main__':
    ...
    # weights_path = "/mnt/f/1.中国农大/数据集/vcnu_pretrain_weight/pretrain/pretrain_weights/VIT/B_32_imagenet1k.pth"
